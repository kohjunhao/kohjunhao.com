...
export default function NotFound() {
  return (
    <div className="mx-auto w-full max-w-4xl px-6 sm:px-10 min-h-screen flex flex-col items-center justify-center text-center relative py-24">
      ...
      <div className="h-10" />
      <h1 className="font-serif text-[clamp(1.9rem,5vw,2.6rem)] font-medium text-ink tracking-[-0.01em] leading-[1.1]">
        この道はない。
      </h1>
      <div className="h-8" />
      <Link
        href="/"
        className="group relative mono text-[0.7rem] tracking-[0.22em] uppercase text-accent active:scale-[0.96] transition-transform duration-150"
      >
        ← return to the index
      ...
      <div className="absolute bottom-7 mono text-[0.58rem] tracking-[0.22em] uppercase text-muted opacity-60">
